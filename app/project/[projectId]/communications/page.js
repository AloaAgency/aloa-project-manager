...
import CreateRequestForm from '@/components/communications/CreateRequestForm';
  ...
  return (
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-6 px-4 py-6">
      <div>
        ...
        <p className="text-sm text-slate-600">Track all requests and agency communications for this project.</p>
      </div>
      ...
      <CreateRequestForm projectId={projectId} onCreated={handleCreated} />
