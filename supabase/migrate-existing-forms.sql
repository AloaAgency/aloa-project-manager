-- Migrate existing forms from legacy forms table to aloa_forms
-- This script copies forms that were created for Aloa projects to the new aloa_forms table
...
-- Now run the constraint fix to point to aloa_forms
